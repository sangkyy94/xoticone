      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              storeDetailViewStoresRecord.nameStore!,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          storeDetailViewStoresRecord.address!,
                              ...
                              child: ExpandableNotifier(
                                ...
                                child: ExpandablePanel(
                                  ...
                                  collapsed: Container(
                                    ...
                                    child: Text(
                                      storeDetailViewStoresRecord.description!,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyText2,
                                    ),
                                  ),
                          ...
                          stream: queryProductsRecord(
                            queryBuilder: (productsRecord) =>
                                productsRecord.where('Store_UUID',
                                    isEqualTo:
                                        storeDetailViewStoresRecord.storeUUID),
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
