...
class UploadSelectStrainWidget extends StatefulWidget {
  const UploadSelectStrainWidget({
    Key? key,
    this.storeRef,
    this.productsRef,
  }) : super(key: key);
  ...
  @override
  _UploadSelectStrainWidgetState createState() =>
      _UploadSelectStrainWidgetState();
}
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: FFLocalizations.of(context).getText(
                          'c1eutyb7' /* Search Strain for your product... */,
                        ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '5qm7vb4y' /* Select  strain to upload for y... */,
                                    ),
                                    style:
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0, 10, 0, 0),
                                  child: FutureBuilder<List<StrainsRecord>>(
                                    future: StrainsRecord.search(
                                      term: searchBarController!.text,
                                    ),
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            listViewStrainsRecordList.length,
                                        itemBuilder: (context, listViewIndex) {
                                          final listViewStrainsRecord =
                                              listViewStrainsRecordList[
                                                  listViewIndex];
                                          return Padding(
                                            padding:
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  'THC : ${listViewStrainsRecord.thc?.toString()}, CBD : ${listViewStrainsRecord.cbd?.toString()}',
                                                                  textAlign:
                                                                      TextAlign
                                                                          .start,
                                                                  style: FlutterFlowTheme.of(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'pxilk21u' /* Request add new strain if you ... */,
                                    ),
                                    style:
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'vej3wv8k' /* Select item for your product l... */,
                                    ),
                                    style:
                                        FlutterFlowTheme.of(context).bodyText2,
                                  ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '35lxncr7' /* Select item for your product l... */,
                                    ),
                                    style:
                                        FlutterFlowTheme.of(context).bodyText2,
                                  ),
