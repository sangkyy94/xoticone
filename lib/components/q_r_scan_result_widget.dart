...
class _QRScanResultWidgetState extends State<QRScanResultWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<StampCouponsRecord>>(
      stream: queryStampCouponsRecord(
        queryBuilder: (stampCouponsRecord) =>
            stampCouponsRecord.where('Coupon_Id', isEqualTo: widget.couponID),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<StampCouponsRecord> photoUploadStampCouponsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final photoUploadStampCouponsRecord =
            photoUploadStampCouponsRecordList.isNotEmpty
                ? photoUploadStampCouponsRecordList.first
                : null;
        return Container(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await photoUploadStampCouponsRecord!
                                          .reference
