...
class StoreStoreListInfoWidget extends StatefulWidget {
  const StoreStoreListInfoWidget({
    Key? key,
    this.ownerRef,
  }) : super(key: key);
  ...
  @override
  _StoreStoreListInfoWidgetState createState() =>
      _StoreStoreListInfoWidgetState();
}

class _StoreStoreListInfoWidgetState extends State<StoreStoreListInfoWidget> {
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            '3eiai4yf' /* STORE LIST For Store Info */,
          ),
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'u1z7kefs' /* Select Your Shop to update sto... */,
                        ),
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'r681f5r2' /* Please select one of your stor... */,
                              ),
                              style: FlutterFlowTheme.of(context).bodyText1,
                            ),
                          ),
