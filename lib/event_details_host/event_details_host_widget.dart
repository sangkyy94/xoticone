...
import '../participant_list/participant_list_widget.dart';
import 'dart:ui';
...
class EventDetailsHostWidget extends StatefulWidget {
  const EventDetailsHostWidget({
    Key? key,
    this.eventRef,
  }) : super(key: key);
  ...
  @override
  _EventDetailsHostWidgetState createState() => _EventDetailsHostWidgetState();
}

class _EventDetailsHostWidgetState extends State<EventDetailsHostWidget>
                                ...
                                child: StreamBuilder<List<ParticipantDBRecord>>(
                                  stream: queryParticipantDBRecord(
                                    queryBuilder: (participantDBRecord) =>
                                        participantDBRecord.where('eventRef',
                                            isEqualTo:
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: CircularPercentIndicator(
                                      percent: functions.ratioFromTwoVariables(
                                          widget.eventRef!.numberParticipants!,
