...
import '../store_decoration/store_decoration_widget.dart';
...
class StoreStoreListDecorateWidget extends StatefulWidget {
  const StoreStoreListDecorateWidget({
    Key? key,
    this.ownerRef,
  }) : super(key: key);
  ...
  @override
  _StoreStoreListDecorateWidgetState createState() =>
      _StoreStoreListDecorateWidgetState();
}

class _StoreStoreListDecorateWidgetState
    extends State<StoreStoreListDecorateWidget> {
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '8f39etl0' /* Select Your Shop For Decoratio... */,
                        ),
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '90i52xhf' /* Please select one of your stor... */,
                              ),
                              style: FlutterFlowTheme.of(context).bodyText1,
                            ),
                          ),
