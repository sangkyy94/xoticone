                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '0pu1wxkm' /* My Favorite Store List */,
                                    ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '2a97bluu' /* My Favorite Strain List */,
                                    ),
                                    style: FlutterFlowTheme.of(context).title3,
                                  ),
                                ),
                                StreamBuilder<List<StrainsRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<StrainsRecord>
                                        columnStrainsRecordList =
                                        snapshot.data!;
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: List.generate(
                                          columnStrainsRecordList.length,
                                          (columnIndex) {
                                        final columnStrainsRecord =
                                            columnStrainsRecordList[
                                                columnIndex];
                                        return Padding(
                                          padding:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(16,
                                                                      0, 0, 0),
                                                          child: Text(
                                                            'THC : ${columnStrainsRecord.thc?.toString()}% , CBD : ${columnStrainsRecord.cbd?.toString()} %',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .subtitle2,
                                                          ),
