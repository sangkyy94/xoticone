...
class StoreStoreListCouponWidget extends StatefulWidget {
  const StoreStoreListCouponWidget({
    Key? key,
    this.ownerRef,
  }) : super(key: key);
  ...
  @override
  _StoreStoreListCouponWidgetState createState() =>
      _StoreStoreListCouponWidgetState();
}

class _StoreStoreListCouponWidgetState
    extends State<StoreStoreListCouponWidget> {
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'ei4nc9fh' /* Please select one of your stor... */,
                              ),
                              style: FlutterFlowTheme.of(context).bodyText1,
                            ),
                          ),
