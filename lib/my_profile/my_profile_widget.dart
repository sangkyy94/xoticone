                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ListView(
                        ...
                        scrollDirection: Axis.vertical,
                        children: [
                          StreamBuilder<List<MyPuffStoryRecord>>(
                            stream: queryMyPuffStoryRecord(
                              queryBuilder: (myPuffStoryRecord) =>
                                  myPuffStoryRecord.where('Writer',
                                      isEqualTo: currentUserReference),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              ...
                              List<MyPuffStoryRecord>
                                  wrapMyPuffStoryRecordList = snapshot.data!;
                              return Wrap(
                                spacing: 8,
                                runSpacing: 4,
                                ...
                                children: List.generate(
                                    wrapMyPuffStoryRecordList.length,
                                    (wrapIndex) {
