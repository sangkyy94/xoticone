...
class StoreStoreListMessageCopyWidget extends StatefulWidget {
  const StoreStoreListMessageCopyWidget({
    Key? key,
    this.ownerRef,
  }) : super(key: key);
  ...
  @override
  _StoreStoreListMessageCopyWidgetState createState() =>
      _StoreStoreListMessageCopyWidgetState();
}

class _StoreStoreListMessageCopyWidgetState
    extends State<StoreStoreListMessageCopyWidget> {
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          's462s8ia' /* Select Your Shop to check user... */,
                        ),
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'm4tu7ybk' /* Please select one of your stor... */,
                              ),
                              style: FlutterFlowTheme.of(context).bodyText1,
                            ),
                          ),
