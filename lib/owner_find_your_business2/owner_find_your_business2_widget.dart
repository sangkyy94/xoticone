...
class OwnerFindYourBusiness2Widget extends StatefulWidget {
  const OwnerFindYourBusiness2Widget({
    Key? key,
    this.user,
  }) : super(key: key);
  ...
  @override
  _OwnerFindYourBusiness2WidgetState createState() =>
      _OwnerFindYourBusiness2WidgetState();
}

class _OwnerFindYourBusiness2WidgetState
    extends State<OwnerFindYourBusiness2Widget> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'byb0b3tc' /* Ownership Verification */,
                      ),
                      style: FlutterFlowTheme.of(context).title2.override(
                            fontFamily: 'Poppins',
                            color: Colors.white,
                        ...
                        Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'hvuvpmli' /* 1. Search Your Business */,
                                ),
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'k7s597ph' /* If you think your business Inf... */,
                        ),
                        style: FlutterFlowTheme.of(context).bodyText1,
                      ),
                    ),
